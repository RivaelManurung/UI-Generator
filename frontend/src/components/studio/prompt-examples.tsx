    ...
    <div className="space-y-2">
      ...
      <div className="grid gap-2">
        {examplePrompts.map((item) => {
          ...
          return (
            <button
              className="group rounded-xl border border-border bg-card p-3 text-left shadow-sm transition hover:bg-muted/60 w-full"
              key={item.title}
            ...
            >
              <div className="flex gap-3">
                <div className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-muted text-muted-foreground group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
