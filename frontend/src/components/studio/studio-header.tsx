  ...
  return (
    <header className="sticky top-0 z-40 flex h-14 items-center justify-between border-b border-border bg-background/95 px-3 backdrop-blur supports-[backdrop-filter]:bg-background/80">
      <div className="flex min-w-0 items-center gap-3">
        <Link
          className="inline-flex h-9 shrink-0 items-center justify-center gap-2 rounded-lg border border-transparent px-3 text-xs font-semibold text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
          href="/app/projects"
        >
        ...
        <div className="flex min-w-0 items-center gap-2.5">
          ...
          <div className="flex min-w-0 flex-col leading-none">
            ...
            <button
              ...
              className="-mx-1 mt-0.5 inline-flex min-w-0 items-center gap-1 rounded-md px-1 py-0.5 transition-colors hover:bg-muted disabled:hover:bg-transparent"
            >
              <span className="truncate text-xs font-bold text-foreground">{projectName}</span>
      ...
      <div className="flex items-center gap-2 shrink-0">
        <Badge className="gap-1.5 rounded-lg border-transparent bg-sky/60 px-3 py-1.5 text-xs font-bold text-galaxy" variant="outline">
          <CreditCard className="h-3.5 w-3.5 text-planetary" />
          {credits} Credits
        </Badge>
